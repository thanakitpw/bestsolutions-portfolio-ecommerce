    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-[var(--background)]">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-semibold mt-4 mb-1">สมัครสมาชิก</h1>
          <p className="text-sm text-[var(--muted-foreground)]">สร้างบัญชีใหม่เพื่อเริ่มช้อปปิ้ง</p>
        </div>
        ...
        <div className="bg-white border border-[var(--border)] rounded-2xl p-8 shadow-sm">
          ...
          {success && (
            <div className="mb-4 px-4 py-3 bg-green-50 border border-green-200 text-green-600 text-sm rounded-xl">
              {success} กำลังพาไปหน้าเข้าสู่ระบบ...
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isPending}
              className="w-full py-3 bg-[var(--primary)] text-[var(--primary-foreground)] text-sm font-semibold rounded-xl hover:opacity-90 transition-opacity disabled:opacity-60 flex items-center justify-center gap-2"
            >
              {isPending ? (
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center text-xs text-[var(--muted-foreground)] bg-white px-3">
              หรือ
            </div>
          </div>
          ...
          <button
            ...
            className="w-full py-3 border border-[var(--border)] text-sm font-medium rounded-xl hover:bg-[var(--muted)] transition-colors flex items-center justify-center gap-2"
          >

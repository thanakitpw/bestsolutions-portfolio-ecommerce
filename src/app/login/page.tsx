    ...
    <div className="min-h-screen bg-[#f8f6f3] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-[var(--border)] p-8">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-white px-3 text-[var(--muted-foreground)]">หรือเข้าสู่ระบบด้วยอีเมล</span>
            </div>
          </div>
        ...
        <p className="text-center text-sm text-[var(--muted-foreground)] mt-6">
          ยังไม่มีบัญชี?{" "}
          <Link href="/register" className="font-semibold text-[var(--foreground)] hover:underline underline-offset-4">
            สมัครสมาชิก
          </Link>
        </p>
      </div>
